...
export const Reports: React.FC<ReportsProps> = ({ user }) => {
  ...
  const generatePDFReport = async () => {
    try {
      ...
      // ------------------------------------------------------------------
      // HEADER WITH NEW NEXORACREW LOGO
      // ------------------------------------------------------------------
      ...
      doc.text(
        "NEXORACREW FINANCIAL STATEMENT",
        pageWidth / 2,
        titleY,
        { align: "center" }
      );
      ...
      doc.text(
        "Official statement generated by NexoraCrew Financial Suite",
        pageWidth / 2,
        titleY + 6,
        { align: "center" }
      );
      ...
      doc.text("HQ: Palakkari, Trichy - 01", 195, startInfoY + 11, { align: "right" });
      doc.text("Email: nexora.crew@gmail.com", 195, startInfoY + 15, { align: "right" });

      // ------------------------------------------------------------------
      // SUMMARY BOXES (Income / Expense / Net)
      // ------------------------------------------------------------------
      let startY = startInfoY + 22;
      const boxWidth = 58;
      const boxHeight = 22;
      const gap = 6;
      ...
      doc.line(sealX - 25, sealY + 25, sealX + 25, sealY + 25);

      doc.setTextColor(0, 0, 0);
      doc.setFont("helvetica", "normal");
      doc.setFontSize(7);
      doc.text("FOUNDER & CEO", sealX, sealY + 29, { align: "center" });
      doc.setFont("helvetica", "bold");
      doc.text("THARSAN", sealX, sealY + 34, { align: "center" });
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
          <h3 className="font-bold mb-6 dark:text-white flex items-center text-lg">
            <Filter size={20} className="mr-2 text-blue-500" /> Report Configuration
          </h3>
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-slate-100 dark:bg-slate-700 rounded-lg p-1">
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-md text-sm font-bold transition-all ${reportType === 'monthly'
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-md text-sm font-bold transition-all ${reportType === 'yearly'
                    ? 'bg-white dark:bg-slate-600 shadow text-blue-600 dark:text-white'
                    : 'text-slate-500'
                    }`}
                >
            ...
            <div className="flex gap-4">
              <div className="flex-1 space-y-2">
                ...
                <select
                  ...
                  className="w-full p-3 rounded-lg border border-slate-200 dark:bg-slate-700 dark:border-slate-600 outline-none focus:ring-2 focus:ring-blue-500"
                >
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 flex flex-col">
          <h3 className="font-bold mb-6 dark:text-white flex items-center text-lg">
            <FileBarChart size={20} className="mr-2 text-emerald-500" /> Payment Analysis
          </h3>
          ...
          <div className="flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
            {stats.length > 0 ? (
              stats.map((stat, idx) => (
                <div
                  key={idx}
                  className="flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                >
                  ...
                  <span
                    className={`font-bold font-mono ${stat.amount >= 0 ? 'text-emerald-600' : 'text-rose-500'
                      }`}
                  >
          ...
          <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <p className="text-xs text-slate-400 text-center mt-4">
              Showing Net Flow (Income - Expense)
            </p>
          </div>
        </div>
      </div>
